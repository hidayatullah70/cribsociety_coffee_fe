          ...
          <Card className="flex flex-col items-start p-6 space-y-3 border-brand-black-muted bg-brand-black-card">
            ...
            <div className="flex items-center gap-2 pt-2">
              <a
                ...
                title="Instagram @cribsociety_coffee"
              >
              ...
              <a
                ...
                className="p-2.5 rounded-xl bg-brand-black-soft hover:bg-brand-black-muted text-brand-red transition-colors border border-brand-black-muted hover:border-brand-red/40"
                aria-label="TikTok"
                title="TikTok Crib Society Cafe"
              >
                <svg className="w-4 h-4 fill-current text-brand-red" viewBox="0 0 24 24">
                  <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64c.298-.002.595.042.88.13V9.4a6.33 6.33 0 0 0-1-.08A6.34 6.34 0 0 0 3 15.66a6.34 6.34 0 0 0 10.82 4.46 6.27 6.27 0 0 0 1.86-4.46V8.75a8.28 8.28 0 0 0 4.91 1.6V6.9a4.86 4.86 0 0 1-1-.21z" />
                </svg>
              </a>
            </div>
          </Card>
